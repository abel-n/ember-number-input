...
test("_calculateUpdatedData – manipulation – Ctrl + Delete", function(assert) {
  ...
  assert.deepEqual(component._calculateUpdatedData("-1234567890.12345", { start: 4, end: 15 }, { key: "Delete", ctrlKey: true }), { value: "-12345", caretData: { start: 4, end: 4 } });
  assert.deepEqual(component._calculateUpdatedData("-1234567890.12345", { start: 14, end: 5 }, { key: "Delete", ctrlKey: true }), { value: "-1234345", caretData: { start: 5, end: 5 } });
});
